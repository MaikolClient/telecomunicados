...
class AuthController {
            ...
            if(empty($alertas)) {
                ...
                if(!$usuario || !$usuario->confirmado ) {
                    ...
                    if( password_verify($_POST['password'], $usuario->password) ) {
                        ...
                        //Insertar log de inicio de sesion en la base de datos
                        $usuario->insertarLog($usuario->nombre . ' ' . $usuario->apellido); 
    ...
    public static function registro(Router $router) {
        ...
        $router->render('auth/registro', [
            'titulo' => 'Crea tu cuenta en Telecomunicados',
            'usuario' => $usuario, 
            'alertas' => $alertas
        ]);
    }
    ...
    public static function reestablecer(Router $router) {
        ...
        if(empty($usuario)) {
            Usuario::setAlerta('error', 'Token No Válido, Intentalo  nuevamente');
            $token_valido = false;
        }
    ...
    public static function confirmar(Router $router) {
        ...
        $router->render('auth/confirmar', [
            'titulo' => 'Confirma tu cuenta Telecomunicados',
            'alertas' => Usuario::getAlertas()
        ]);
    }
