...
class Paginacion {
    ...
    public function enlace_anterior(){
        $html = '';
        if($this->anterior()){
            $html .= "<a class=\"paginacion__enlace paginacion__enlace--texto\" href=\"?page={$this->anterior()}\">&laquo; Anterior</a>";
        }
        return $html;
    }
    ...
    public function enlace_siguiente(){
        $html = '';
        if($this->siguiente()){
            $html .= "<a class=\"paginacion__enlace paginacion__enlace--texto\" href=\"?page={$this->siguiente()}\">Siguiente &raquo;</a>";
        }
        return $html;
    }
